          ...
          <div className="relative p-3 border-t border-white/5 bg-black/20">
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 rounded-xl bg-white/10 border border-white/10 px-4 py-2.5 text-base sm:text-sm text-foreground placeholder:text-muted/30 focus:outline-none focus:border-cyan/50 focus:bg-white/15 transition-colors"
              />
              <button
                onClick={sendMessage}
